...
public class PermissionFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (list.contains("sharedDocuments")|| list.contains("share") || list.contains("auth") || list.contains("getUser") ||list.contains("getAll") || list.contains("getPath") || list.contains("ws") || list.contains("getUser") || list.contains("getContent") || httpRequest.getMethod().equals(HttpMethod.OPTIONS.toString()) || httpRequest.getMethod().equals(HttpMethod.GET.toString())) {
            flag = true;
        }
